                ...
                <div class="table-responsive">
                  <div class="form-group">
                        <div class="col-sm-4">
                            ...
                            <asp:TextBox type="number" class="form-control" ID="txtLegajo" runat="server"></asp:TextBox>
                            </div>
                    ...
                    <br />
                        <br />
                    <div class="form-group">
                         <asp:GridView ID="GvRemolque" DataKeyNames="id" CssClass="table table-bordered table-hover table-striped" runat="server" OnRowEditing="GvRemolque_edit" OnRowDeleting="GvRemolque_delete" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
