    ...
    public partial class Estadisticas : SiCoVeMaster
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                //ddlGraficos.Items.Insert(3, new ListItem("Acarreos por Zona", "3"));
                //ddlGraficos.Items.Insert(4, new ListItem("Denuncias por Zona", "4"));
                //ddlGraficos.Items.Insert(5, new ListItem("Infracciones por Categoría", "5"));
                ddlGraficos.SelectedIndex = 1;
