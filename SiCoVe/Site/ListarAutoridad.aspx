                ...
                <div class="table-responsive">
                  <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        ...
                        <br />
                    <div class="form-group">
                         <asp:GridView ID="GvAutoridad" DataKeyNames="id" onrowcommand="GvAutoridad_RowCommand" OnRowDeleting="GvAutoridad_delete" CssClass="table table-bordered table-hover table-striped" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
