                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="dni">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator14" ControlToValidate="txtDepartamentoDNI" runat="server" ErrorMessage="* Debe Ingresar Departamento"></asp:RequiredFieldValidator>--%>
                                        </div>
                                        <div class="form-group">
                                            <label>Puerta</label>
                                            <asp:TextBox  ID="txtPuertaDNI" runat="server" class="form-control"></asp:TextBox>
                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator15" ControlToValidate="txtPuertaDNI" runat="server" ErrorMessage="* Debe Ingresar Puerta"></asp:RequiredFieldValidator>--%>
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <%--   <asp:DropDownList ID="ddlLugNacimientoDNI" runat="server" class="form-control"></asp:DropDownList>--%>
                                            ...
                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator16" ControlToValidate="txtLugarNacimientoDNI" runat="server" ErrorMessage="* Debe Ingresar Lugar Nacimiento"></asp:RequiredFieldValidator>--%>
                                        </div>
                                    </div>
                                    <!-- Datos licencia -->
                                    <div class="tab-pane fade" id="licencia">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator23" ControlToValidate="txtObservaciones" runat="server" ErrorMessage="* Debe ingresar las observaciones"></asp:RequiredFieldValidator>--%> 
                                        </div>
                                    </div>
                                    <!-- Datos cédula -->
                                    <div class="tab-pane fade" id="cedula">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator34" ControlToValidate="txtTitularCED" runat="server" ErrorMessage="* Debe ingresar Tutular" display="Dynamic" CssClass="label label-danger"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <!-- Datos seguro -->
