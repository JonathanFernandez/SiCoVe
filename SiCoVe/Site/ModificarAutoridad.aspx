                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="dni">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:CompareValidator ID="CVddlSexo" ControlToValidate="ddlSexo" runat="server" ValueToCompare="0" Operator="NotEqual" Display ="Dynamic" ErrorMessage="* Debe seleccionar Nacionalidad" CssClass="label label-danger"></asp:CompareValidator>
                                        </div>
                                        <div class="form-group">
