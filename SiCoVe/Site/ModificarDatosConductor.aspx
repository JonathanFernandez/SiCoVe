...
<div id="page-wrapper">
                         ...
                         <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Modificar / Eliminar Conductor</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                  <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        ...
                        <br />
                    <div class="form-group">
                         <asp:GridView ID="GvConductor" DataKeyNames="id" onrowcommand="GvConductor_RowCommand" OnRowEditing="GvConductor_edit" OnRowDeleting="GvConductor_delete" CssClass="table table-bordered table-hover table-striped" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
